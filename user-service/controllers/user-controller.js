const { getUserHandler, getUsersHandler, createUserHandler, updateUserPreferenceHandler } = require("../handlers/user-handler");
...
const updateUserController = async (req, res) => {
    try {
        ...
        const updatedUser = await updateUserPreferenceHandler(email, preferences, channel); //need to do validation
